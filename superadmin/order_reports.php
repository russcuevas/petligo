                        ...
                        <div class="body">
                            ...
                            <div id="printable-area" class="table-responsive mt-3">
                                <div class="d-flex justify-content-start align-items-center" style="gap: 0;">
                                    ...
                                    <a href="#" class="btn bg-red waves-effect btn-sm filter-button">
                                        <i class="material-icons">filter_list</i> <span class="filter-span">APPOINTMENT REPORTS</span>
                                    </a>
                                    <a href="#" class="btn bg-red waves-effect btn-sm filter-button">
                                        <i class="material-icons">filter_list</i> <span class="filter-span">ORDER REPORTS</span>
                                    </a>
                                </div>
