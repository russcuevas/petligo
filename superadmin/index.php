...
<body class="theme-red">
    ...
    <nav class="navbar" style="color: #945034;">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2 style="font-size: 25px; font-weight: 900; color: #945034 !important;">DATA ANALYTICS</h2>
            </div>

            <!-- Widgets -->
            <div class="row clearfix">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-red hover-expand-effect" style="background-color: #945034 !important;">
                        <div class="icon">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-red hover-expand-effect" style="background-color: #945034 !important;">
                        ...
                        <div class="content">
                            <div class="text" style="color: white !important;">ALL SALES</div>
                            <div class="" style="font-size: 20px; color: white !important">10</div>
                        </div>
                    </div>
                </div>
